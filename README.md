...
This was a fairly simple coding challenge from the start of 2017.
Ember Engines was in the very early stages of development and a desired implementation for the company that set the challenge.
As can be seen, this was before Bower use was removed, the `@ember` (namespaced NPM repo) was implemented, or even jQuery could be optionally removed.
Another quirk you may notice is the use of `ember-cli-windows-addon` which was a helper towards developing/running on Windows machines.

Here was the original description of the challenge:
